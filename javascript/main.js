function showOtherInput() {
    select = document.getElementById("selectTrainingPlace").value;
    label = document.getElementById("hiddenLabel");
...
function showContacts() {
    ...
    medicalDiv = document.getElementById("medicalDiv");
    contactDiv.removeAttribute("hidden", "");
    medicalDiv.setAttribute("hidden", "");
}

function showMedicals() {
    contactDiv = document.getElementById("contactDiv");
    medicalDiv = document.getElementById("medicalDiv");
    contactDiv.setAttribute("hidden", "");
    medicalDiv.removeAttribute("hidden", "");
}
